...
namespace MistCore.Data
{
    ...
    {
        ///// <summary>
        ///// Gets or sets the entity DAO.
        ///// </summary>
        ///// <value>
        ///// The entity DAO.
        ///// </value>
        //IRepository<TEntity> EntityDao { get; set; }
    ...
    /// </summary>
    /// <typeparam name="TEntity">The type of the entity.</typeparam>
    public interface IDomainService<TEntity, TEntityDTO> : IDomainService where TEntity : class, IEntity where TEntityDTO : class, IEntity
    {
        ///// <summary>
        ///// Gets or sets the entity DAO.
        ///// </summary>
